...
<Image src="/images/job-description-and-task-management-vector.jpg" alt="img" width={1000} height={1000}/>
</div>
...
data-aos-delay={150}>
    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-8 lg:leading-16">
        Get applications from the world bext talents.
    </h1>
    <p className="mt-6 text-gray-700 dark:text-gray-300">
       Search  all the open positions on the web. Get your own personallizes
...
<div className="mt-8">
 ...
 <div className="flex items-center space-x-2 mb-4">
        <BiCheck className="w-7 h-7 text-pink-600"/>
        <span className="text-gray-700 dark:text-gray-300 font-medium">
          Capitalize on low hanging fruit to identity
        </span>
    </div>
